...
async def bootstrap_cluster():
    ...
    async with Client(endpoint="https://node1.api.domain.com", api_key="ADMIN_MASTER_TOKEN") as admin:
...
async def developer_workflow():
    async with Client(endpoint="https://node1.api.domain.com", api_key="phx_live_vladimir_...") as cloud:
